...
int main()
{
    ...
    cout << "choice 11  : Reversion of a linked list (Non Recursive way)" << endl;
    cout << "choice 12  : Find mid of the Linked List " << endl;
    cout << "choice 13  : Make a cycle at Kth position " << endl;
    cout << "choice 14  : Detect Cycle (If available)" << endl;
    cout << "choice 15  : Delete Cycle (If available)" << endl;
